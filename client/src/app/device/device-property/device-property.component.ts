...
import { MatLegacyDialogRef as MatDialogRef, MAT_LEGACY_DIALOG_DATA as MAT_DIALOG_DATA, MatDialog } from '@angular/material/legacy-dialog';
...
import { DeviceType, DeviceSecurity, MessageSecurityMode, SecurityPolicy, ModbusOptionType, EthernetIPModule, ETHERNETIPMODULE_PREFIX, Device, ModbusReuseModeType } from './../../_models/device';
